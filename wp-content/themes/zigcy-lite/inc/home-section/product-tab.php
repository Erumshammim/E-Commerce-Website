          ...
          ?>
            ...
            <div class="pwtb-catname-wrapper">
                ...
                foreach ( $category_array as $category ) :
                    ...
                    if ( $category_object ) {
                        ?>
                        <a href="#" class="pwtb-catname" id="pwtb-cat-<?php echo esc_attr( $category_object->term_id ); ?>" data-id="<?php echo esc_attr($category_object->term_id);?>"  data-col='columns-4' data-slug="<?php echo esc_attr($category_object->name); ?>">
            ...
            <div class="pwtb-catposts-wrapper woocommerce <?php //echo esc_attr($rating_class)?>">
                        ...
                        $category_object = get_term( $first_cat, 'product_cat' );
                            if ((!is_wp_error( $category_object )) && ($category_object)){
                                ...
                                <?php if ( $feat_prod_tab_query->have_posts() ) : ?>
                                   <ul class="pwtb-inner-catposts-wrapper products columns-4 cat-posts-<?php echo esc_attr( $category_object->term_id ); ?> sm-woo-tab-cat-wrapper <?php echo esc_attr($category_object->name);?> ">
