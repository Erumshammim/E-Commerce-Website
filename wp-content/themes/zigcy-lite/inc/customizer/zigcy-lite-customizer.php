  ...
  $wp_customize->add_control( 'zigcy_lite_social_new_tab', array(
    ...
    foreach( $social_icons as $social_icon){
      ...
      $wp_customize->add_control( 'zigcy_lite_'.$social_icon.'_url', array(
            'section'       => 'zigcy_lite_social_icons',
            'label'         => esc_html__(' ','zigcy-lite').$social_icon,
            'type'          => 'url'
        ));
    }
...
$wp_customize->add_control( 'zigcy_lite_smart_slider', array(
  ...
  /** drop down categories for features **/
  $wp_customize->add_setting( 'zigcy_lite_product_categories_one',array(
      'sanitize_callback' => 'absint',
      'default'           => 0,
    ));
  $wp_customize->add_control( 'zigcy_lite_product_categories_one', array(
      'label'       => esc_html__(' Category One', 'zigcy-lite'),
  ...
  $wp_customize->add_setting( 'zigcy_lite_product_categories_two',array(
      'sanitize_callback' => 'absint',
      'default'           => 0,
    ));
  $wp_customize->add_control( 'zigcy_lite_product_categories_two', array(
      'label'       => esc_html__('Select Category Two', 'zigcy-lite'),
      'description' => esc_html__('The list will display categories from Product', 'zigcy-lite'),
      'section'     => 'zigcy_lite_pro_cat_setting',
      'type'        => 'select',
      'choices'     => $zigcy_lite_prod_cats,
  ...
  $wp_customize->add_setting( 'zigcy_lite_product_categories_three',array(
    'sanitize_callback' => 'absint',
    'default'           => 0,
  ));
  $wp_customize->add_control( 'zigcy_lite_product_categories_three', array(
      'label'       => esc_html__('Select Category Three', 'zigcy-lite'),
      'description' => esc_html__('The list will display categories from Product', 'zigcy-lite'),
      'section'     => 'zigcy_lite_pro_cat_setting',
      'type'        => 'select',
      'choices'     => $zigcy_lite_prod_cats,
  ...
  //instructions
  $wp_customize->add_setting( 'bingle_instructions', array(
      'sanitize_callback'    => 'sanitize_text_field'
  ));

  $wp_customize->add_control( new Bingle_Customize_Info( $wp_customize,'bingle_instructions', array(
      'section'         => 'zigcy_lite_pro_cat_setting',
  ...
  //instructions
  $wp_customize->add_setting( 'bingle_instructions_two', array(
      'sanitize_callback'    => 'sanitize_text_field'
  ));

  $wp_customize->add_control( new Bingle_Customize_Info( $wp_customize,'bingle_instructions_two', array(
      'section'         => 'zigcy_lite_prod_cat_slider_setting',
      'label'           => esc_html__('Instructions','zigcy-lite'),
      'description'     => esc_html__('Install WooCommerce Plugin to list options','zigcy-lite'),
  )));
  ...
  //instructions
  $wp_customize->add_setting( 'bingle_instructions_one', array(
      'sanitize_callback'    => 'sanitize_text_field'
  ));

  $wp_customize->add_control( new Bingle_Customize_Info( $wp_customize,'bingle_instructions_one', array(
      'section'         => 'zigcy_lite_feat_prod_cat_setting',
      'label'           => esc_html__('Instructions','zigcy-lite'),
      'description'     => esc_html__('Install WooCommerce Plugin to list options','zigcy-lite'),
  )));
...
$wp_customize->add_control( 'zigcy_lite_blog_subtitle',array(
  ...
  //instructions
  $wp_customize->add_setting( 'bingle_instructions_three', array(
      'sanitize_callback'    => 'sanitize_text_field'
  ));

  $wp_customize->add_control( new Bingle_Customize_Info( $wp_customize,'bingle_instructions_three', array(
      'section'         => 'zigcy_lite_prod_tab_cat_setting',
      'label'           => esc_html__('Instructions','zigcy-lite'),
      'description'     => esc_html__('Install WooCommerce Plugin to list options','zigcy-lite'),
  )));
